...
- place: {{"item": "crafting_table"|"furnace"|"chest"}} — set a block you CARRY down in the world (craft it first if you have none). Leave the spot to your body; it finds legal ground. A placed table or furnace is village infrastructure — anyone can use it.
- store: {{"item": "wood"|"stone"|"coal"|"raw_iron"|"food", "count": 1-16}} — put goods into the nearest chest (count optional, 16 is the default). Your body finds the chest; if none stands nearby you are told so, and the answer is to craft and place one.
- retrieve: {{"item": "wood"|"stone"|"coal"|"raw_iron"|"food", "count": 1-16}} — take goods back out of the nearest chest (count optional, 16 is the default). Useful when your pack is empty but the village stores are not.
