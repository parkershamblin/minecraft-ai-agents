...
class Settings(BaseSettings):
    ...
    # Live bot bodies (positions / orphan sweep). Compose overrides to the
    # service DNS name; host-run tests keep localhost.
    minecraft_service_url: str = "http://localhost:8003"
