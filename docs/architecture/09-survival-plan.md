...
| SV-14 | Gear | equip-best-gear logic (weapon tier table + leather armor auto-equip, hand-rolled; armor-manager only if spike lane B earns the dep). Depends on commit C's enum entries | S/M |
