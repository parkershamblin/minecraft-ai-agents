...
|---|--:|--:|--:|--:|--:|--:|--:|
| `llama3.1:8b` | 5 | 5/5 | 945.3 ± 329.2 | 1.14 ± 0.82 | 0.602 ± 0.198 | 454227 ± 149529 | 1678 ± 106 |
| `gemma4:latest` | 5 | 5/5 | 1001.3 ± 605.8 | 0.62 ± 0.56 | 0.745 ± 0.101 | 548793 ± 344063 | 8529 ± 501 |
| `gemma3:12b` | 5 | 4/5 | 650.9 ± 150.7 | 0.53 ± 0.24 | 0.763 ± 0.079 | 772969 ± 1253815 | 3596 ± 142 |
| `qwen3.5:4b` | 5 | 0/5 | — | 0.33 ± 1.43 | 0.038 ± 0.095 | 286854 ± 154176 | 111160 ± 2331 |
| `lfm2.5:latest` | 5 | 0/5 | — | 0.14 ± 0.22 | 0.385 ± 0.117 | 1392557 ± 76921 | 23647 ± 2537 |
...
## Per-run appendix (kept runs)

| Model | Run | Outcome | Duration s | Attempt |
|---|--:|---|--:|---|
| `llama3.1:8b` | 1 | won | 700.9 | `019f9400-fa5c…` |
| `llama3.1:8b` | 2 | won | 680.9 | `019f940c-4b74…` |
| `llama3.1:8b` | 3 | won | 1101.7 | `019f9417-5049…` |
| `llama3.1:8b` | 4 | won | 941.1 | `019f9428-cda9…` |
| `llama3.1:8b` | 5 | won | 1301.8 | `019f9437-c7b9…` |
| `gemma3:12b` | 1 | stalled | 5544.8 | `019f944e-1d39…` |
| `gemma3:12b` | 2 | won | 580.5 | `019f94a3-67e1…` |
| `gemma3:12b` | 3 | won | 580.8 | `019f94ac-e843…` |
| `gemma3:12b` | 4 | won | 661.1 | `019f94b6-620c…` |
| `gemma3:12b` | 5 | won | 781.1 | `019f94c1-1747…` |
| `gemma4:latest` | 1 | won | 941.3 | `019f94ce-431a…` |
| `gemma4:latest` | 2 | won | 981.3 | `019f94dd-42e8…` |
| `gemma4:latest` | 3 | won | 640.9 | `019f94ec-e90b…` |
| `gemma4:latest` | 4 | won | 1822.1 | `019f94f7-5557…` |
| `gemma4:latest` | 5 | won | 620.7 | `019f9513-c413…` |
| `qwen3.5:4b` | 1 | stalled | 4504.8 | `019f951e-e8d2…` |
| `qwen3.5:4b` | 2 | stalled | 4503.7 | `019f9564-48bb…` |
| `qwen3.5:4b` | 3 | stalled | 4505.6 | `019f95a9-9fbf…` |
| `qwen3.5:4b` | 4 | stalled | 4504.8 | `019f95ee-fe1a…` |
| `qwen3.5:4b` | 5 | stalled | 4504.8 | `019f9634-5bdc…` |
| `lfm2.5:latest` | 1 | stalled | 4505.1 | `019f967a-6085…` |
| `lfm2.5:latest` | 2 | stalled | 4505.5 | `019f96bf-c302…` |
| `lfm2.5:latest` | 3 | stalled | 4505.1 | `019f9705-28c3…` |
| `lfm2.5:latest` | 4 | stalled | 4505.5 | `019f974a-899b…` |
| `lfm2.5:latest` | 5 | stalled | 4505.2 | `019f978f-e7f3…` |
